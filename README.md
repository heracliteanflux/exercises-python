...
* [Create Beautiful Tracebacks with Python’s Exception Hooks](https://python.plainenglish.io/creating-beautiful-tracebacks-with-pythons-exception-hooks-c8a79e13558d)
...
* [What Are pyc Files and __pycache__ folders In Python ?](https://codesolid.com/what-are-those-pyc-files-in-a-python-project/)
...
Geron, Aurelion. (2022). _Hands-On Machine Learning with Scikit-Learn, Keras, and TensorFlow: Concepts, Tools, and Techniques to Build Intelligent Systems_. 3rd Ed. O'Reilly. [GitHub](https://github.com/ageron/handson-ml3).

Grus, Joel. (2019). _Data Science from Scratch: First Principles with Python_. O'Reilly Media. [GitHub](https://github.com/joelgrus/data-science-from-scratch).

McKinney, Wes. (2022). _Python for Data Analysis: Data Wrangling with Pandas, NumPy, and Jupyter_. 3rd Ed. O'Reilly. [Home](https://wesmckinney.com/book/). [GitHub](https://github.com/wesm/pydata-book/tree/3rd-edition).

* Bader, Dan. (2017). _Python Tricks: A Buffet of Awesome Python Features_. [Home](https://realpython.com/products/python-tricks-book/).
* Danjou, Julien. (2018). _Serious Python: Black-Belt Advice on Deployment, Scalability, Testing, and More_. No Starch Press.
...
* Hilpisch, Yves. (2020). _Python for Algorithmic Trading: From Idea to Cloud Deployment_. O'Reilly Media.
* Hilpisch, Yves. (2019). _Python for Finance: Mastering Data-Driven Finance, 2nd Ed_. O'Reilly Media.
* Hilpisch, Yves. (2015). _Derivatives Analytics with Python: Data Analysis, Models, Simulation, Calibration and Hedging_. Wiley.
* Johansson, Robert. (2019). _Numerical Python: Scientific Computing and Data Science Applications with NumPy, SciPy, and Matplotlib_. Apress.
* Kalb, Irv. (2021). _Object-Oriented Python: Master OOP by Building Games and GUIs_. [No Starch Press](https://nostarch.com/object-oriented-python).
* Kopec, David. (2019). _Classic Computer Science Problems in Python_. Manning Publications.
* Liu, Mark. (2021). _Make Python Talk: Build Apps with Voice Control and Speech Recognition_. [No Starch Press](https://nostarch.com/make-python-talk).
* Lubanovic, Bill. (2019). _Introducing Python: Modern Computing in Simple Packages, 2nd Ed_. O'Reilly Media.
* Matthes, Eric. (2019). _Python Crash Course: A Hands-On, Project-Based Introduction to Programming_. O'Reilly Media.
* Mayer, Christian. (2020). _Python One-Liners: Write Concise, Eloquent Python like a Professional_. [No Starch Press](https://nostarch.com/pythononeliners).
* McClain, Bonny P. (2022). _Python for Geospatial Data Analysis: Theory, Tools, and Practice for Location Intelligence_. O'Reilly.
* McKinney, Wes. (2017). _Python for Data Analysis: Data Wrangling with Pandas, NumPy, and IPython_. 2nd Ed. O'Reilly. [GitHub](https://github.com/wesm/pydata-book).
* Nunez-Iglesias, Juan, Stefan van der Walt, & Harriet Dashnow. (2017). [_Elegant SciPy: The Art of Scientific Python_](https://github.com/elegant-scipy/elegant-scipy). O'Reilly.
...
* Sweigart, Al. (2019). _Automate the Boring Stuff with Python: Practical Programming for Total Beginners, 2nd Ed_. [No Starch Press](https://nostarch.com/automatestuff2).
* Sweigart, Al. (2015). [_Automate the Boring Stuff with Python: Practical Programming for Total Beginners_](https://automatetheboringstuff.com). No Starch Press.
* Tuckfield, Bradford. (2021). _Dive Into Algorithms: A Pythonic Adventure for the Intrepid Beginner_. [No Starch Press](https://nostarch.com/Dive-Into-Algorithms).
* VanderPlas, Jake. (2016). _Python Data Science Handbook: Essential Tools for Working with Data_. O'Reilly.
* Vasiliev, Yuri. (2022). _Python for Data Science: A Hands-On Introduction_. No Starch Press.
* Vaughan, Lee. (2022). _Python Tools for Scientists: An Introduction to Using Anaconda, JupyterLab, and Python's Scientific Libraries_. [No Starch Press](https://nostarch.com/python-tools-scientists).
* Vaughan, Lee. (2020). _Real-World Python: A Hacker's Guide to Solving Problems with Code_. No Starch Press.
* Vaughan, Lee. (2018). _Impractical Python Projects: Playful Programming Activities to Make You Smarter_. [No Starch Press](https://nostarch.com/impracticalpythonprojects).
* Viafore, Patrick. (2021). _Robust Python: Write Clean and Maintainable Code_. O'Reilly.
* Youens-Clark, Ken. (2020). _Tiny Python Projects_. Manning.